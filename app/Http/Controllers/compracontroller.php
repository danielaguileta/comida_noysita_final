...
class compracontroller extends Controller
{
    ...
    {
        $compras = Http::get('https://comidanoysitaapifinal-production.up.railway.app/compras/')->json();
    ...
    {
        $compras = Http::post('https://comidanoysitaapifinal-production.up.railway.app/insertar_compra', [
    ...
    {
        $compras  = Http::put('https://comidanoysitaapifinal-production.up.railway.app/compras/edit/'. $COD_COMPRA ,[
            'NOMBRE_PRODUCTO'=> $request->nombre_producto,
            'PRECIO_PRODUCTO' => $request->precio_producto,
            'CANTIDAD_PRODUCTO' => $request->cantidad_producto,
            'CATALOGO_PRODUCTO'=> $request->catalogo_producto,
    ...
    {
        $compras = Http::delete('https://comidanoysitaapifinal-production.up.railway.app/compras/delete/'. $COD_COMPRA);
