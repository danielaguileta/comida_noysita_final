...
class facturacontroller extends Controller
{
    ...
    {
        $facturas = Http::get('https://comidanoysitaapifinal-production.up.railway.app/facturas/')->json();
    ...
    {
        $facturas = Http::post('https://comidanoysitaapifinal-production.up.railway.app/insertar_factura', [
    ...
    {
        $facturas  = Http::put('https://comidanoysitaapifinal-production.up.railway.app/facturas/edit/'. $COD_FACTURA ,[
            'NUMERO_FACTURA'=> $request->numero_factura,
            'NOMBRE_CLIENTE' => $request->nombre_cliente,
            'RTN_CLIENTE' => $request->rtn,
            'FECHA_FACTURACION'=> $request->fecha_facturacion,
