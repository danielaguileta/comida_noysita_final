...
class empleadoscontroller extends Controller
{
    ...
    {
        $empleados = Http::get('https://comidanoysitaapifinal-production.up.railway.app/empleados/')->json();
    ...
    {
        $empleados = Http::post('https://comidanoysitaapifinal-production.up.railway.app/insertar_empleado', [
    ...
    {
        $empleados = Http::put('https://comidanoysitaapifinal-production.up.railway.app/empleados/edit/' .$COD_EMPLEADO ,[
            'NOMBRE_EMPLEADO'=> $request->nombre,
            'IDENTIDAD_EMPLEADO' => $request->identidad,
            'EDAD_EMPLEADO' => $request->edad,
            'CORREO_EMPLEADO'=> $request->correo_empleado,
    ...
    {
        $empleados = Http::delete('https://comidanoysitaapifinal-production.up.railway.app/empleados/delete/'. $COD_EMPLEADO);
